...
const tools: ToolInfo[] = [
  {
    ...
    freeUsage: "New users receive 10 free Agent checkpoints and 20 Advanced Assistant edit requests.",
    paidPlan: {
      name: "Replit Core",
      price: "$20",
  ...
  },
  {
    ...
    url: "https://bolt.new/",
    logo: "/logos/bolt.png",
    description: "Can pick your preferred tech stack (NextJS, Vite, etc), so good for opinionated devs",
    ...
    hasSecrets: true,
    difficultyLevel: "Intermediate",
    additionalNotes: "Asks for API keys if you need them (has a concept of a .env file). Can hook to Supabase for a database."
  },
];
          ...
          <div className="container px-4 mx-auto">
            <div className="max-w-6xl mx-auto">
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-purple-100 dark:bg-purple-900/50">
                      <th className="p-4 text-left border-b dark:border-gray-700 font-semibold w-[180px]">Tool</th>
                      <th className="p-4 text-left border-b dark:border-gray-700 font-semibold">Description</th>
                      <th className="p-4 text-left border-b dark:border-gray-700 font-semibold">Free Usage</th>
                      <th className="p-4 text-left border-b dark:border-gray-700 font-semibold">Paid Plan</th>
                      <th className="p-4 text-center border-b dark:border-gray-700 font-semibold">Database</th>
                      <th className="p-4 text-center border-b dark:border-gray-700 font-semibold">API Keys</th>
                      <th className="p-4 text-left border-b dark:border-gray-700 font-semibold">Difficulty</th>
                    </tr>
                  </thead>
                  <tbody>
                    {tools.map((tool, index) => (
                      <tr 
                        key={tool.name}
                        className={index % 2 === 0 ? "bg-white/50 dark:bg-gray-800/20" : "bg-purple-50/50 dark:bg-gray-800/40"}
                      >
                        ...
                        <td className="p-4 border-b dark:border-gray-700 align-top">
                          <div className="text-sm">
                            <div className="font-semibold">{tool.paidPlan.name} - {tool.paidPlan.price}</div>
                        ...
                        <td className="p-4 border-b dark:border-gray-700 text-center align-middle">
                          <span className={tool.hasDatabase ? "text-green-600 font-bold" : "text-red-600"}>
                            {tool.hasDatabase ? "✓" : "✗"}
                          </span>
                        </td>
                        <td className="p-4 border-b dark:border-gray-700 text-center align-middle">
                          <span className={tool.hasSecrets ? "text-green-600 font-bold" : "text-red-600"}>
                            {tool.hasSecrets ? "✓" : "✗"}
                          </span>
                        </td>
                        <td className="p-4 border-b dark:border-gray-700 align-middle">
                          <span className={
                            tool.difficultyLevel === "Beginner-friendly" ? "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-2 py-1 rounded-full text-xs" :
                            tool.difficultyLevel === "Intermediate" ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 px-2 py-1 rounded-full text-xs" :
              ...
              <div className="md:hidden space-y-6 mt-6">
                {tools.map((tool) => (
                  <div key={tool.name} className="bg-white/50 dark:bg-gray-800/50 rounded-lg shadow-sm p-4 border dark:border-gray-700">
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Description</div>
                        <div className="text-sm">{tool.description}</div>
                      </div>
                      
                      <div>
                        <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Free Usage</div>
                        <div className="text-sm">{tool.freeUsage}</div>
                      </div>
                      
                      <div>
                        <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Paid Plan</div>
                        <div className="text-sm">
                          <span className="font-semibold">{tool.paidPlan.name} - {tool.paidPlan.price}</span>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div>
                          <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Database</div>
                          <div className="text-sm">
                            <span className={tool.hasDatabase ? "text-green-600 font-bold" : "text-red-600"}>
                              {tool.hasDatabase ? "✓" : "✗"}
                            </span>
                        ...
                        <div>
                          <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">API Keys</div>
                          <div className="text-sm">
                            <span className={tool.hasSecrets ? "text-green-600 font-bold" : "text-red-600"}>
                              {tool.hasSecrets ? "✓" : "✗"}
                            </span>
                        ...
                        <div>
                          <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Difficulty</div>
                          <div className="text-sm">
                            <span className={
                              tool.difficultyLevel === "Beginner-friendly" ? "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-2 py-1 rounded-full text-xs" :
                              tool.difficultyLevel === "Intermediate" ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 px-2 py-1 rounded-full text-xs" :
                      ...
                      {tool.additionalNotes && (
                        <div>
                          <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Additional Notes</div>
              ...
              <div className="mt-12 text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  All pricing and features are current as of March 2025. Please check the official websites for the most up-to-date information.
                </p>
              </div>
            </div>
          </div>
